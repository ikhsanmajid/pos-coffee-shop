...
<template>
    ...
    <div class="min-h-screen grid grid-cols-1 lg:grid-cols-12 bg-[#FAF7F2] font-sans selection:bg-amber-200 selection:text-amber-900">
        ...
        <div class="hidden lg:flex lg:col-span-7 relative overflow-hidden bg-amber-950">
            <!-- Background Image -->
            <img 
                src="/images/coffee_shop_login.png" 
            ...
            <div class="absolute inset-0 z-10 flex items-center justify-center p-16 text-white">
                <!-- Logo/Brand Center -->
                <div class="flex flex-col items-center gap-4 text-center bg-amber-950/20 backdrop-blur-md px-10 py-12 rounded-3xl border border-white/10 shadow-2xl">
                    <div class="bg-white/10 p-4 rounded-2xl border border-white/20 shadow-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-12 h-12 text-amber-100">
                            <path d="M11.645 20.91l-.007-.003-.022-.012a15.247 15.247 0 01-.383-.218 25.18 25.18 0 01-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3A5.5 5.5 0 0112 5.052 5.5 5.5 0 0116.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.111-4.739 9.256a25.175 25.175 0 01-4.244 3.17 15.247 15.247 0 01-.383.219l-.022.012-.007.004-.003.001a.752.752 0 01-.704 0l-.003-.001z" />
                        </svg>
                    </div>
                    <span class="font-extrabold text-3xl tracking-widest text-amber-50 drop-shadow">POS Coffee Shop</span>
                </div>
            </div>
        </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center cursor-pointer group">
                            ...
                            />
                            <span class="ms-2.5 text-sm text-amber-800 font-medium group-hover:text-amber-950 transition-colors">
