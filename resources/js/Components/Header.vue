        ...
        <div class="flex items-center gap-2">
            ...
            <button @click="isProfileOpen = !isProfileOpen" type="button"
                ...
                <div class="flex flex-col items-end hidden sm:flex">
                    <span
                        class="text-xs font-semibold text-gray-700 dark:text-gray-200 group-hover:text-amber-600 dark:group-hover:text-amber-500 transition-colors">Ikhsan</span>
                    <span class="text-[10px] text-gray-400 font-medium">Cashier Shift A</span>
                </div>
                <div
    ...
    <Teleport to="body">
        ...
        <Transition enter-active-class="transition-all duration-200 ease-out"
            ...
            <div v-if="isProfileOpen"
                ...
                <div class="px-3 py-2.5 border-b border-gray-100 dark:border-gray-700/40 mb-1 sm:hidden">
                    <p class="text-xs font-bold text-gray-800 dark:text-gray-200">Ikhsan</p>
                    <p class="text-[10px] text-gray-400 mt-0.5">Cashier Shift A</p>
                </div>
